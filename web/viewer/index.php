<?php
     ...
     * @since 2015-08-06 (date of creation)
    ...
    $focalPlaneDistance = ($focalPlanes[$maxPlane]->getFocusPosition() - $focalPlanes[0]->getFocusPosition())
        / $maxPlane;
    //
    $hierarchySeparator = ' » ';
    ...
    <head lang="en">
        ...
        <style type="text/css">
            * { padding: 0; margin: 0; color: #eee; font-size: 12px; line-height: 14.4px; font-family: "Lucida Sans Unicode", "Lucida Grande", "Tahoma", sans-serif; }
            ...
            #video { position: absolute; top: 300px; left: 630px; width: 160px; height: 120px; }
    ...
    <body>
        <main>
            ...
            <section class="feedback">
                <a href="http://cms.virmisco.org/index.php/contact.html" target="_blank">Leave feedback</a>
            </section>
            <div id="controls">
            ...
            <section class="wrapper">
                ...
                <section id="metadata">
                    ...
                    <section>
                        <h2>Organism</h2>
                        <dl>
                            <dt>number</dt><dd><?php out($specimenCarrier->getCarrierNumber()) ?>-<?php out($organism->getSequenceNumber()) ?>&#xa0;</dd>
                    ...
                    <section>
                        <h2>Microscope slide</h2>
                        <dl>
                            <dt>carrier number</dt><dd><?php out($specimenCarrier->getCarrierNumber()) ?>&#xa0;</dd>
                            <dt>preparation type</dt><dd><?php out($specimenCarrier->getPreparationType()) ?>&#xa0;</dd>
                            <dt>owner</dt><dd><?php out($specimenCarrier->getOwner()) ?>&#xa0;</dd>
                    ...
                    <section>
                        <h2>Gathering</h2>
                        <dl>
                            <dt>journal number</dt>
                            <dd><?php out($gathering->getJournalNumber()) ?>&#xa0;</dd>
                            <dt>sampling date</dt>
                            <dd><?php out($gathering->getSamplingDate()) ?>&#xa0;</dd>
                            <dt>gathering agent</dt>
                            <dd><?php out($gathering->getAgent()) ?>&#xa0;</dd>
                            <dt>location</dt>
                            <dd><?php out($gathering->getLocation()) ?>&#xa0;</dd>
                            <dt>remarks</dt>
                            <dd><?php out($gathering->getRemarks()) ?>&#xa0;</dd>
                        </dl>
                    </section>
                    <section>
