<?php
     ...
     * @version 2016-06-27 (date of last modification)
     * @since 2016-06-27 (date of creation)
    ...
    class PhotomicrographDigitizedV2 extends AbstractEvent
    {
        /** @var int */
        ...
        /** @var bool */
        private $microscopeSettingsIsPolarizerInLightPath;
        /** @var float */
         ...
         * @param string $cameraReadoutNoise
        ...
        public function __construct(
            ...
            $this->cameraReadoutNoise = (string)$cameraReadoutNoise;
            ...
            $this->microscopeNumberOfPorts = (int)$microscopeNumberOfPorts;
            ...
            $this->microscopeSettingsIsPolarizerInLightPath = (bool)$microscopeSettingsIsPolarizerInLightPath;
         ...
         * @return int
         */
        public function getMicroscopeNumberOfPorts()
        {
            return $this->microscopeNumberOfPorts;
        }
         ...
         * @return boolean
         */
        public function isMicroscopeSettingsPolarizerInLightPath()
        {
            return $this->microscopeSettingsIsPolarizerInLightPath;
        }
    }
