<?php
     ...
     * @since 2015-08-13 (date of creation)
...
AND (:dateBefore IS NULL OR `g`.`sampling_date__before` <= :dateBefore)
AND (:dateOnOrAfter IS NULL OR `g`.`sampling_date__after` >= :dateOnOrAfter)
